...
//CROSS-TASK COMMUNICATION 
  ...
  int high_score = 0; //load in from EEPOM on intialization
...
//LEVEL CREATION LOGIC 
  ...
  void create_level(){
    ...
    for (int i = 0; i < LEVEL_SIZE; i++){
      //if column is a pipe, randomly generate a bottom 
